...
const tabs = ref([
  ...
  },
  {
    ...
    content: [
      {
        tech: {
          backend: ["Node", "Express", "Go", "MongoDB"],
          frontend: [
            "Javascript",
            "Typescript",
            "HTML",
  ...
  <div class="tabs-container vertical">
    ...
    >
      <div class="content">
        <EducationItems
          :info="item"
          v-if="tabs[activeTab].label === 'Education'"
        />
        <ProjectsItems
          :info="item"
          v-if="tabs[activeTab].label === 'Projects'"
        />
        <SkillsItems
          :info="item"
          v-if="tabs[activeTab].label === 'Experience'"
        />
